...
function SessionsDAO(db) {
    ...
    this.startSession = function(username, fullname, callback) {
        "use strict";
        ...
        var session = {'username': username, 'fullname': fullname, '_id': session_id};
    ...
    this.getUsername = function(session_id, callback) {
        ...
        sessions.findOne({ '_id' : session_id }, function(err, session) {
            ...
            callback(null, {'username': session.username, 'fullname': session.fullname});
        });
    }
}
